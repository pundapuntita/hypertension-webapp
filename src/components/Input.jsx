            ...
            <div className="flex items-center gap-1.5 mb-2 ml-1">
                ...
                {tooltipInfo && (
                    <div className="relative group/tooltip flex items-center">
                        ...
                        <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-0 lg:-translate-x-1/2 lg:left-1/2 w-[calc(100vw-4rem)] max-w-[280px] sm:max-w-xs p-3 bg-gray-900/95 backdrop-blur-md text-white text-xs rounded-xl shadow-xl z-50 font-normal border border-white/10 opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-all duration-300 translate-y-1 group-hover/tooltip:translate-y-0 pointer-events-none text-left">
                            <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-2 lg:-translate-x-1/2 lg:left-1/2 w-3 h-3 bg-gray-900/95 rotate-45 border-r border-b border-white/10"></div>
                            <span className="relative z-10 block whitespace-normal sm:whitespace-pre-wrap leading-relaxed break-words">{tooltipInfo}</span>
                        </div>
                    </div>
                )}
            </div>
